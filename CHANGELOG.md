...
**Patch — `site/index.html` visual identity refresh.** Página GitHub Pages reskin pra nova identidade dark-first navy/cyan da LCV Ideas & Software (paleta `#050b18`/`#38bdf8`/`#34d399`, gradientes radiais, glow shadows, gradient text no h1). Companion ship coordenado com cross-review-v1 1.12.9, cross-review-v2 v2.18.7, deepseek-cli 0.3.1, grok-cli 1.6.2 e `.github-org/site` (root + /sponsor). Sem mudança no Worker runtime; apenas a página GitHub Pages do repo é afetada.
