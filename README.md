...
| **`v01.02.02`** | **Identidade visual da LCV Ideas & Software.** Reskin de `site/index.html` (GitHub Pages) na paleta dark-first navy/cyan institucional atual (`#050b18`/`#38bdf8`/`#34d399`, gradientes, glow). Companion ship coordenado com `cross-review-v1` 1.12.9, `cross-review-v2` v02.18.07, `deepseek-cli` 0.3.1, `grok-cli` 1.6.2 e `.github-org/site` (org root + /sponsor). Sem mudança no Worker runtime; apenas a página GitHub Pages muda. |
