...
| ------------------------- | ------------- | ----------------- | ----------- | ----------------------------------------------------------------------------------------------- |
| hono                      | ^4.13.5       | MIT               | runtime     | https://www.npmjs.com/package/hono                                                              |
...
| @biomejs/biome            | ^2.5.11       | MIT OR Apache-2.0 | development | https://www.npmjs.com/package/@biomejs/biome                                                    |
| @cloudflare/workers-types | ^5.20260823.1 | MIT OR Apache-2.0 | development | https://www.npmjs.com/package/@cloudflare/workers-types                                         |
