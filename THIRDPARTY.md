...
| ------------------------- | ------------- | ----------------- | ----------- | ----------------------------------------------------------------------------------------------- |
| hono                      | ^4.13.3       | MIT               | runtime     | https://www.npmjs.com/package/hono                                                              |
...
| @cloudflare/workers-types | ^5.20260820.1 | MIT OR Apache-2.0 | development | https://www.npmjs.com/package/@cloudflare/workers-types                                         |
