...
test('Linear Release uses an immutable official action and explicit CLI version', () => {
  const officialUses = linearRelease.match(
  ...
  assert.match(linearRelease, /^[ \t]*cli_version: v\d+\.\d+\.\d+[ \t]*$/mu);
